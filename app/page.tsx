      ...
      <div className="relative z-10 w-full px-4 md:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto md:ml-0 text-center">
          ...
          <p className="text-lg md:text-xl lg:text-2xl text-white">
            Discover <span className="font-bold">healthcare services</span> tailored just for you. Our platform offers <span className="font-bold">advanced management capabilities</span> you would not find anywhere else.
          </p>
